//
// Created by Krishna Chamarthy on 11/09/26.
//

#ifndef HAZEL_APPLICATIONEVENT_H
#define HAZEL_APPLICATIONEVENT_H
...
namespace Engine {
    ...
    public:
        WindowsResizeEvent(unsigned int width, unsigned int height) : m_Width(width), m_Height(height) {}
...
#endif //HAZEL_APPLICATIONEVENT_H
